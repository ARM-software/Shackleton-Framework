...
void llvm_pass_set_valid_values(object_llvm_pass_str* o) {
    ...
    values[0] = "-mergereturn";
    values[1] = "-mem2reg";
    values[2] = "-basicaa";
    values[3] = "-loop-deletion";
    values[4] = "-loop-accesses";
    values[5] = "-elim-avail-extern";
    values[6] = "-slp-vectorizer";
    values[7] = "-profile-summary-info";
    values[8] = "-ipconstprop";
    values[9] = "-instcombine";
    values[10] = "-memcpyopt";
    values[11] = "-assumption-cache-tracker";
    values[12] = "-sccp";
    values[13] = "-strip-debug-declare";
    values[14] = "-loop-extract-single";
    values[15] = "-dce";
    values[16] = "-loop-idiom";
    values[17] = "-strip";
    values[18] = "-bdce";
    values[19] = "-instcount";
    values[20] = "-loop-distribute";
    values[21] = "-phi-values";
    values[22] = "-iv-users";
    values[23] = "-constprop";
    values[24] = "-globaldce";
    values[25] = "-pgo-memop-opt";
    values[26] = "-reg2mem";
    values[27] = "-da";
    values[28] = "-early-cse-memssa";
    values[29] = "-always-inline";
    values[30] = "-transform-warning";
    values[31] = "-early-cse";
    values[32] = "-argpromotion";
    values[33] = "-float2int";
    values[34] = "-correlated-propagation";
    values[35] = "-globalopt";
    values[36] = "-scalar-evolution";
    values[37] = "-lcssa";
    values[38] = "-scoped-noalias";
    values[39] = "-sroa";
    values[40] = "-alignment-from-assumptions";
    values[41] = "-loops";
    values[42] = "-callsite-splitting";
    values[43] = "-loop-rotate";
    values[44] = "-rpo-functionattrs";
    values[45] = "-lazy-block-freq";
    values[46] = "-loop-simplify";
    values[47] = "-intervals";
    values[48] = "-indvars";
    values[49] = "-tti";
    values[50] = "-strip-dead-prototypes";
    values[51] = "-simplifycfg";
    values[52] = "-memdep";
    values[53] = "-constmerge";
    values[54] = "-tailcallelim";
    values[55] = "-tbaa";
    values[56] = "-domfrontier";
    values[57] = "-module-debuginfo";
    values[58] = "-basiccg";
    values[59] = "-strip-nondebug";
    values[60] = "-postdomtree";
    values[61] = "-die";
    values[62] = "-licm";
    values[63] = "-mldst-motion";
    values[64] = "-inferattrs";
    values[65] = "-instsimplify";
    values[66] = "-inline";
    values[67] = "-domtree";
    values[68] = "-branch-prob";
    values[69] = "-lcssa-verification";
    values[70] = "-aggressive-instcombine";
    values[71] = "-strip-dead-debug-info";
    values[72] = "-lowerswitch";
    values[73] = "-deadargelim";
    values[74] = "-scev-aa";
    values[75] = "-div-rem-pairs";
    values[76] = "-regions";
    values[77] = "-loweratomic";
    values[78] = "-speculative-execution";
    values[79] = "-functionattrs";
    values[80] = "-called-value-propagation";
    values[81] = "-lowerinvoke";
    values[82] = "-lower-expect";
    values[83] = "-reassociate";
    values[84] = "-gvn";
    values[85] = "-loop-sink";
    values[86] = "-lazy-value-info";
    values[87] = "-libcalls-shrinkwrap";
    values[88] = "-barrier";
    values[89] = "-opt-remark-emitter";
    values[90] = "-ipsccp";
    values[91] = "-lazy-branch-prob";
    values[92] = "-codegenprepare";
    values[93] = "-prune-eh";
    values[94] = "-demanded-bits";
    values[95] = "-mergefunc";
    values[96] = "-adce";
    values[97] = "-ee-instrument";
    values[98] = "-forceattrs";
    values[99] = "-jump-threading";
    values[100] = "-dse";
    values[101] = "-loop-unroll";
    values[102] = "-targetlibinfo";
    values[103] = "-partial-inliner";
    values[104] = "-break-crit-edges";
    values[105] = "-loop-vectorize";
    values[106] = "-loop-unswitch";
    values[107] = "-memoryssa";
    values[108] = "-loop-extract";
    values[109] = "-sink";
    values[110] = "-verify";
    values[111] = "-loop-reduce";
    values[112] = "-aa";
    values[113] = "-loop-load-elim";
    values[114] = "-block-freq";
    values[115] = "-globals-aa";
